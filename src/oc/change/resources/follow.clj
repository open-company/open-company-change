...
(schema/defn ^:always-validate retrieve
  :- {:user-id lib-schema/UniqueID :org-slug lib-follow/Slug :follow-publisher-uuids (schema/maybe [lib-schema/UniqueID]) :unfollow-board-uuids (schema/maybe [lib-schema/UniqueID])}
...
(schema/defn ^:always-validate retrieve-board-unfollowers
  ...
  [org-slug :- lib-follow/Slug unfollow-board-uuid :- lib-schema/UniqueID]
  (lib-follow/retrieve-board-unfollowers c/dynamodb-opts org-slug unfollow-board-uuid))
...
(schema/defn ^:always-validate retrieve-all-board-unfollowers
  :- [{:org-slug lib-follow/Slug :unfollower-uuids [lib-schema/UniqueID] :board-uuid lib-schema/UniqueID :resource-type lib-follow/ResourceType}]
  [org-slug :- lib-follow/Slug]
  (lib-follow/retrieve-all-board-unfollowers c/dynamodb-opts org-slug))

(schema/defn ^:always-validate store!
  [user-id :- lib-schema/UniqueID org-slug :- lib-follow/Slug follow-publisher-uuids :- [lib-schema/UniqueID] unfollow-board-uuids :- [lib-schema/UniqueID]]
  (lib-follow/store! c/dynamodb-opts user-id org-slug follow-publisher-uuids unfollow-board-uuids))

(schema/defn ^:always-validate store-publishers!
  [user-id :- lib-schema/UniqueID org-slug :- lib-follow/Slug follow-publisher-uuids :- [lib-schema/UniqueID]]
  (lib-follow/store-publishers! c/dynamodb-opts user-id org-slug follow-publisher-uuids))

(schema/defn ^:always-validate store-boards!
  [user-id :- lib-schema/UniqueID org-slug :- lib-follow/Slug unfollow-board-uuids :- [lib-schema/UniqueID]]
  (lib-follow/store-boards! c/dynamodb-opts user-id org-slug unfollow-board-uuids))
